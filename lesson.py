...
def lesson(unit, _lesson, correct, incorrect,acc):
    ...
    graph_button = {
        'graph_btn' : button(300,150,{"x" :  450,"y" : 430}, "Display Accuracy?","Arial",35,(200,200,200),(255,255,255),90,0,(50,50,50),False)
    }
    ...
    if len(answered_questions) == 5:
        ...
        if if_clicked(graph_button['graph_button'],event) == True:
