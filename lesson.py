...
import random
import time
from basic_functions import pystart, clear, button, display_buttons, if_clicked, final_surface
...
def option_define(unit, _lesson,question):
    ...
    option1 = random.choice(options[0])
        
    option2 = random.choice(options[1])
        
    option3 = answer_gather(question)
        
    option4 = random.choice(options[3])
...
def lesson(unit, _lesson, correct, incorrect):
    ...
    while question in correct or question in incorrect:
        questions = question_gather(unit, _lesson)
        question = random.choice(questions)
        options = option_define(unit, _lesson, question)
    option1 = options[0]
    option2 = options[1]
    option3 = answer_gather(question)
    option4 = options[3]
    ...
    'option4_btn' : button(300,150,{"x" :  650,"y" : 530}, options[3],"Arial",35,(200,200,200),(255,255,255),int(xoffset_gather(options[3])),int(yoffset_gather(options[3])),(50,50,50)),     
    'quit_btn': button(250,50,{"x" :  10,"y" : 730},"Quit", "Arial",35,(200,200,200),(255,255,255),90,0,(50,50,50))
    }
